...
1.0	 Jul-17-2017  David Chung		Updated for production EVB and S32DS for Power v1.2
*******************************************************************************/
