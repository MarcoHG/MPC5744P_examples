...
/* Rev 1.1 Jul 17 2017 D Chung - production version */
...
* can.h determine mode of operation of this demo.  DEVKIT = 1 if using DEVKIT-MPC5744P,
...
* ------------------------------------------------------------------------------
* Test HW:         DEVKIT-MPC5744P or MPC5744P 257BGA/144LQFPDS + MPC57XXMB
* MCU:             MPC5744P
 ...
 */
#if DEVKIT && !LOOPBACK
#error "Loopback mode must be configured if using DEVKIT-MPC5744P. Either change the macro in can.h or change hardware setup."
#endif
